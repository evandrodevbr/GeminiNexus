      ...
      en: {
        translation: {
          ...
          proxy: {
            ...
            routing: {
              currentMappings: 'Current Model Mappings',
              modelMapping: 'Anthropic model routing configuration',
              noMapping: 'No model mappings configured.',
              upstreamProxy: 'Outgoing proxy configuration',
              status: 'Status',
              enabled: 'Enabled',
              disabled: 'Disabled',
              url: 'URL',
            ...
            advanced: {
              ...
              parity: {
                title: 'Parity Counters',
                requests: 'Parity Requests',
                errors: 'Parity Errors',
                shadowComparisons: 'Shadow Comparisons',
                shadowMismatches: 'Shadow Mismatches',
                noGoBlocked: 'No-Go Blocked',
              },
              ideSetup: {
                title: 'IDE Quick Setup',
                cursor: 'Cursor',
                vscode: 'VS Code',
          ...
          usage: {
            title: 'Token Usage',
            description: 'Monitor your API token consumption over time.',
            ...
            emptyStateDescription:
              'Start making API requests to see your token usage statistics here.',
            promptLabel: 'Prompt',
      ...
      'zh-CN': {
        translation: {
          ...
          proxy: {
            ...
            routing: {
              currentMappings: '当前模型映射',
              modelMapping: 'Anthropic 模型路由配置',
              noMapping: '未配置模型映射。',
              upstreamProxy: '出站代理配置',
              status: '状态',
              enabled: '已启用',
              disabled: '已禁用',
              url: 'URL',
            ...
            advanced: {
              ...
              tools: {
                totalRequests: '总请求数',
                matchedRequests: '匹配请求数',
                parityViolations: '一致性违规',
                ideSetup: 'IDE 快速配置',
                copyConfig: '复制配置',
                requestReplay: '请求重放',
                comingSoon: '即将推出',
          ...
          usage: {
            title: 'Token 用量',
            description: '监控您的 API Token 消耗情况。',
            range24h: '最近 24 小时',
            range7d: '最近 7 天',
            range30d: '最近 30 天',
            ...
            allAccounts: '所有账号',
            noData: '暂无数据',
            emptyStateTitle: '暂无用量数据',
            emptyStateDescription: '开始发起 API 请求后，此处将显示您的 Token 用量统计。',
            promptLabel: 'Prompt',
            completionLabel: 'Completion',
            totalLabel: '总计',
            requestsLabel: '请求数',
      ...
      ru: {
        translation: {
          ...
          proxy: {
            ...
            routing: {
              currentMappings: 'Текущие сопоставления моделей',
              modelMapping: 'Конфигурация маршрутизации моделей Anthropic',
              noMapping: 'Сопоставления моделей не настроены.',
              upstreamProxy: 'Конфигурация исходящего прокси',
              status: 'Статус',
              enabled: 'Включено',
              disabled: 'Отключено',
              url: 'URL',
            ...
            advanced: {
              ...
              trafficLog: {
                ...
                noLogs: 'Журналы трафика не найдены',
                timestamp: 'Время',
              ...
              tools: {
                ...
                matchedRequests: 'Совпавшие запросы',
                parityViolations: 'Нарушения паритета',
                ideSetup: 'Быстрая настройка IDE',
                copyConfig: 'Копировать конфиг',
                requestReplay: 'Повтор запросов',
                comingSoon: 'Скоро',
              },
              trafficLogs: {
                title: 'Журналы трафика',
                filterDirection: 'Фильтр по направлению',
              ...
              parity: {
                title: 'Счетчики паритета',
                requests: 'Запросы паритета',
                errors: 'Ошибки паритета',
                shadowComparisons: 'Теневые сравнения',
                shadowMismatches: 'Теневые несоответствия',
                noGoBlocked: 'Блокировка No-Go',
              },
              ideSetup: {
                title: 'Быстрая настройка IDE',
                cursor: 'Cursor',
                vscode: 'VS Code',
                claudeCode: 'Claude Code',
                copyConfig: 'Копировать конфиг',
          ...
          usage: {
            ...
            description: 'Мониторинг потребления API токенов.',
            range24h: 'Последние 24 часа',
            range7d: 'Последние 7 дней',
            range30d: 'Последние 30 дней',
            totalTokens: 'Всего токенов',
            promptTokens: 'Prompt токены',
            completionTokens: 'Completion токены',
            totalRequests: 'Всего запросов',
            dailyUsage: 'Ежедневное использование',
            byModel: 'По моделям',
            hourlyUsage: 'Почасовое использование',
            loadFailed: 'Не удалось загрузить данные об использовании.',
            retry: 'Повторить',
            allAccounts: 'Все аккаунты',
            noData: 'Нет данных',
            emptyStateTitle: 'Данных об использовании пока нет',
            emptyStateDescription:
              'Начните отправлять API-запросы, чтобы увидеть статистику использования токенов.',
            promptLabel: 'Prompt',
            completionLabel: 'Completion',
            totalLabel: 'Всего',
