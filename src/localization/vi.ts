const vi = {
  ...
  proxy: {
    ...
    advanced: {
      ...
      trafficLogs: {
        title: 'Nhật ký lưu lượng',
        filterDirection: 'Lọc theo hướng',
      ...
      parity: {
        title: 'Bộ đếm Parity',
        requests: 'Yêu cầu Parity',
        errors: 'Lỗi Parity',
        shadowComparisons: 'So sánh Shadow',
        shadowMismatches: 'Không khớp Shadow',
        noGoBlocked: 'No-Go đã chặn',
      },
      ideSetup: {
        title: 'Thiết lập IDE nhanh',
        cursor: 'Cursor',
        vscode: 'VS Code',
        claudeCode: 'Claude Code',
        copyConfig: 'Sao chép cấu hình',
        configCopied: 'Đã sao chép cấu hình!',
      },
      replay: {
        title: 'Phát lại yêu cầu',
